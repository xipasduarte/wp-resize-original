...
class Plugin {
	...
	/**
	 * Register all of the hooks related to the plugin's functionality.
	 *
	 * @since    1.0.0
	 * @access   private
	 */
	private function define_plugin_hooks() {
		...
		$plugin_resize_original = new Admin\ResizeOriginal( $this );

		$this->loader->add_filter( 'wp_insert_attachment_data', $plugin_resize_original, 'enforce_attachment_size', 99, 2 );
